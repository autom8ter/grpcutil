...
type Config struct {
	...
	proxyRegistration   func(ctx context.Context, mux *runtime.ServeMux, port string, opts ...grpc.DialOption) //register json proxies against the servemux(generated by grpc gateway plugin)
...
func AllHeaderMatcherFunc(decider map[string]bool) runtime.HeaderMatcherFunc {
	return func(s2 string) (s string, b bool) {
		return s2, true
	}
}
